        ...
        <div className="max-w-6xl mx-auto md:grid-cols-2 gap-10 items-center w-[95%] h-[90%] rounded-lg bg-gradient-to-r from-teal-100 to-teal-50 p-12">
          <div className="max-w-6xl mx-auto">
            <div className="mb-8 px-5 gap-6">
              ...
              <p className="text-gray-600 text-left px-2 py-8">Choose from our popular service categories  <Link to="/signupcommon" className="bg-teal-400 hover:bg-teal-600 text-white text-sm px-5 py-2 rounded-xl">Booking</Link></p>
            </div>
