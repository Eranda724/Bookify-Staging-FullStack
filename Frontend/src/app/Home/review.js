...
const Review = () => {
  const [reviews, setReviews] = useState([
    ...
    { id: 2, name: "Jane Smith", rating: 4, comment: "Very good experience overall." },
    { id: 3, name: "Mike Johnson", rating: 5, comment: "Fantastic customer support and quick service." }
  ]);
    ...
    <Navigation /> 
      ...
      <section className='p-10'>
        <div className=" bg-cyan-50 p-6 rounded-lg shadow-md">
            ...
            <button
                type="submit"
                className="bg-blue-500 text-white py-2 px-6 rounded-md hover:bg-blue-600 transition duration-300 font-medium"
            >
                Submit Review
            </button>
            </form>
